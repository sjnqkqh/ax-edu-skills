...
3. [가상 문제 데이터 합성](skills/ax-virtual-problem-data-generate/SKILL.md) (`ax-virtual-problem-data-generate`) — 그 파일로 합성 데이터와 재현 스크립트를 만듭니다. 해결 설계는 쓰지 않습니다.
...
| 가상 문제 데이터 합성 | `ax-virtual-problem-data-generate` | 고른 상황으로 합성 데이터와 재현 스크립트를 만듭니다. 해결 설계는 쓰지 않습니다. |
