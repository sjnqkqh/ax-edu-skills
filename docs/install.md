...
2. `virtual-problem-data-generate`가 만든 재현 스크립트를 돌릴 때는 Python 3가 사용 가능한지 확인합니다.
3. 전체 스킬을 먼저 설치합니다.
...
`virtual-problem-data-generate`가 만든 재현 스크립트는 Python 3가 필요합니다. 패키지가 있으면 그 산출물의 README.md를 따릅니다. 스킬 설치와는 별개입니다.
